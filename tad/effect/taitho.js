        ...
        $("#tad-taoanh").click(function() {
            ...
            html2canvas(document.querySelector(".tad-main"), {
                ...
                canvas.toBlob(function(blob) {
                    ...
                    $(".tad-xemtruoc").click(function() {
                        $(".ip-style").html("<style>.tad-screen, .tad-bg:before { background: url(" + bloburl + ") center; }</style>");
                        $(".btn-tav").attr("download", "taoanhdep_" + tenanhxuat + ".jpg").attr("href", bloburl);
                    });
                }, 'image/jpeg');
                setTimeout(function() {
