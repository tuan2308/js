$(document).ready(function() {
    if (window.location.hostname == tmbq) {
        ...
        $("#tad-taoanh").click(function () {
            ...
            var t0 = $(".tad-in-text0");
            var t0o = $(".tad-out-text0");
            if (t0.length !== 0) {
    
                if (norq.length !== 0) {
                }
    
                else if (t0.val().length == 0) {
                    t0.focus();
                    t0.addClass("is-invalid");
                    return false;
                } else {
            ...
            if (norq.length !== 0) {
                ...
                if (t1.val().length == 0) {
                    ...
                    t1.removeClass("is-invalid");
                    t1o.html(t1.val());
                }
            }
            var t2 = $(".tad-in-text2");
            var t2o = $(".tad-out-text2");
            if (norq.length !== 0) {
            ...
            if (norq.length !== 0) {
                ...
                if (t3.val().length == 0) {
                    t3.focus();
                    t3.addClass("is-invalid");
                    return false;
                } else {
                    t3.removeClass("is-invalid");
                    t3o.html(t3.val());
                }
            }
    
            var ta = $(".tad-in-texta");
            var tao = $(".tad-out-texta");
            if (norq.length !== 0) {
                ...
                if (ta.val().length == 0) {
                    ...
                    tao.html(ta.replace(/\r?\n/g, '</div><div>'));
                    tao.html(ta.val());
                }
            }
    
    
            $(".load-anh").addClass("show");
            html2canvas(document.querySelector(".tad-main"), {
                ...
                $("#tad-taianhve").addClass("show");
                $(".tad-ketqua").addClass("show");
                $(".load-anh").removeClass("show");
            }, 'image/jpeg');
        });
