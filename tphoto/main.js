...
$("#backb1").click(function(){$('#dongtad').modal('show');});$('#dongtad .co').click(function(){canvas.clear();dongbang();});$('#dongtad .khong').click(function(){dongbang();});$("#backb2").click(function(){b2.show();b3.hide();});var tenanh="Tạo ảnh đẹp";var dinhdang="jpg";var kichco=2;$(".dinhdang input").click(function(){dinhdang=$("input:checked").val()});$(".kichco").change(function(){kichco=$(this).val()});$(".tenanh").on("input",function(){var a=$(".tenanh").val()});$("#tad-luuanh").click(function(){canvas.deactivateAll();var a=canvas.width;var b=canvas.height;canvas.setZoom(kichco);canvas.setDimensions({width:a*kichco,height:b*kichco});canvas.renderAll();$("#canvas").get(0).toBlob(function(c){saveAs(c,tenanh+"."+dinhdang)});canvas.setZoom(1);canvas.setDimensions({width:a,height:b})});}});