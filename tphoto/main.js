...
var fonts = ["Roboto", "VT323", "Pacifico", "Amatic SC", "Lobster", "Pattaya"];
...
$("#addText").click(function() {
    ...
    var textbox = new fabric.Textbox(nd, {
        width: tw,
...
var tenanh="Tạo ảnh đẹp";var dinhdang="jpg";var kichco=2;$(".dinhdang input").click(function(){dinhdang=$("input:checked").val()});$(".kichco").change(function(){kichco=$(this).val()});$(".tenanh").on("input",function(){var a=$(".tenanh").val()});$("#tad-luuanh").click(function(){canvas.deactivateAll();var a=canvas.width;var b=canvas.height;canvas.setZoom(kichco);canvas.setDimensions({width:a*kichco,height:b*kichco});canvas.renderAll();$("#canvas").get(0).toBlob(function(c){saveAs(c,tenanh+"."+dinhdang)});canvas.setZoom(1);canvas.setDimensions({width:a,height:b})});