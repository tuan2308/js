...
$(document).ready(function()
	...
	$("#f_chat_source").html("<a target='_blank' href='http://www.startuanit.net/2015/12/code-tao-hop-chatbox-ho-tro-online-cho-fanpage-facebook.html'><i class='fa fa-question-circle'></i> Live Chat Facebook</a><label>"+f_chat_vs+"</label><a title='Star Tuấn Blog' target='_blank' href='http://www.startuanit.net/'> <i class='fa fa-star'></i></a>");
	setTimeout(function()
		{
		f_ck_chat()
	}
...
document.write("<style type=\"text/css\">#chat_f_b_smal
	{
	padding-left: 32px;
}
 #b-c-facebook .chat-f-b, #b-c-facebook .chat-f-b label
